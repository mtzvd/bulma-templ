...
- [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md) — Normative architectural decisions
- [COMMENT_STYLE.md](COMMENT_STYLE.md) — Comment formatting rules
- [LLM_INSTRUCTIONS.md](LLM_INSTRUCTIONS.md) — Non-negotiable rules for AI assistants
...
**Core Principles** (detailed in [CANONICAL_PROJECT_CONTEXT.md](CANONICAL_PROJECT_CONTEXT.md)):
...
- Follow [COMMENT_STYLE.md](COMMENT_STYLE.md) exactly
...
5. **Commit:** Include both `.templ` and generated `*_templ.go` files

**Important:** Always commit generated `*_templ.go` files. They are not ignored by git.
...
- `*_templ.go` — Generated files (committed to repo, regenerated by `task templ`)
- `*.templ` — Source template files
- `*_test.go` — Unit tests
...
2. **Generated files are committed**: Run `task templ` and commit `*_templ.go` files
3. **No architectural contracts are changed**: Review [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md)
4. **Comments follow style guide**: See [COMMENT_STYLE.md](COMMENT_STYLE.md)
...
1. Read [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md) for architectural decisions
2. Check [LLM_INSTRUCTIONS.md](LLM_INSTRUCTIONS.md) for common patterns and examples
...
- **[COMMENT_STYLE.md](COMMENT_STYLE.md)** — Comment formatting rules
- **[LLM_INSTRUCTIONS.md](LLM_INSTRUCTIONS.md)** — Non-negotiable rules for AI assistants
- **[CANONICAL_PROJECT_CONTEXT.md](CANONICAL_PROJECT_CONTEXT.md)** — Comprehensive project context
- **[Bulma Documentation](https://bulma.io/documentation/)** — CSS framework reference
